...
namespace PetAdoption.Api.Controllers
{
    ...
    public class UsersController : ControllerBase
    {
        ...
        public UsersController(IUserPetService userPetService, IAuthService authService)
        {
